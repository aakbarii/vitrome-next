              ...
              <div className="header-info-list hidden md:inline-block">
                <ul className="m-0 p-0 list-none flex">
                  <li className="mr-[25px]">
                    <a href="mailto:Abolnoori2929@gmail.com" className={`text-[15px] font-medium no-underline transition-all duration-300 hover:text-[#8750f7] ${theme === "light" ? "text-[#2a1454]" : "text-white"}`}>{email}</a>
                  </li>
                </ul>
              </div>
