      ...
      <div className="max-w-[1320px] mx-auto px-4">
        <div className="flex flex-wrap -mx-4">
          <div className="w-full md:w-1/2 px-4">
            <div className="mb-[50px] max-w-[700px] w-full" data-aos="fade-up" data-aos-delay="300">
          ...
          <div className="w-full md:w-1/2 px-4">
            <div className="mb-[50px] max-w-[700px] w-full" data-aos="fade-up" data-aos-delay="400">
              <h2 data-aos="fade-up" className="text-[45px] bg-gradient-to-r from-[#8750f7] to-white bg-clip-text text-transparent inline-flex gap-[15px] mb-0">
