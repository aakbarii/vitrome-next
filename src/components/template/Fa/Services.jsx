        ...
        <div className="flex flex-wrap -mx-4">
          <div className="w-full px-4">
            <div className="mb-[50px] max-w-[700px] w-full mx-auto text-center">
              <h2 className="text-[45px] bg-gradient-to-r from-[#8750f7] to-white bg-clip-text text-transparent inline-flex gap-[15px] mb-0" data-aos="fade-up">خدمات با کیفیت من</h2>
              <p className={`mt-[15px] ${theme === "light" ? "text-[#140c1c]" : ""}`} data-aos="fade-up">
