    ...
    >
      <div className="max-w-[1320px] mx-auto px-4">
        <div className="flex flex-wrap -mx-4">
          ...
          <div
            data-aos="fade-right"
            className="w-full lg:w-7/12 xl:w-1/2 xl:ml-[8.333333%] px-4"
          >
                ...
                {comments?.map((comment, index) => (
                  <SwiperSlide key={index}>
                    <div
                      ...
                      } max-w-[300px] w-full rounded-[15px] p-[25px]`}
                    >
                      ...
                      <div className="icon-box mb-[25px] flex gap-[5px]">
                        ...
                        >
                          ...
                          <defs>
                            ...
                            >
                              <stop offset="1" stopColor="#8750f7"></stop>
                              <stop
                                offset="1"
                                stopColor="#140C1C"
                                stopOpacity="0"
                      ...
                      <p
                        className={`quote text-[16px] mb-[50px] min-h-[75px] ${rtlClass} ${
                          theme === "light" ? "text-[#140c1c]" : ""
                        }`}
                      >
                        {comment.paragraph}
                      ...
                      <h4
                        className={`name text-[18px] mb-[5px] ${rtlClass} ${
                      ...
                      <span
                        className={`designation text-[14px] block ${rtlClass} ${
                          theme === "light" ? "text-[#140c1c]" : ""
                        }`}
                      >
                        {comment.position}
